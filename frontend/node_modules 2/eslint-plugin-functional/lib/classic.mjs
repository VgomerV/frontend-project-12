...
function createRuleUsingFunction(name, meta, defaultOptions, createFunction) {
    const ruleCreator = RuleCreator((ruleName) => `https://github.com/eslint-functional/eslint-plugin-functional/blob/v6.6.3/docs/rules/${ruleName}.md`);
    return ruleCreator({
        name,
        meta: meta,
        defaultOptions,
