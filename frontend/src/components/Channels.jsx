  ...
  return (
    <div className="col-4 col-md-2 border-end px-0 bg-light flex-column h-100 d-flex">
      <div className="d-flex mt-1 justify-content-between mb-2 ps-4 pe-2 p-4">
        ...
        <button type="button" className="p-0 text-primary btn btn-group-vertical" onClick={() => dispatch(openModal({ type: 'add' }))}>
          ...
          return (
            <li key={uniqueId()} className="nav-item w-100">
              <Dropdown as={ButtonGroup} className="d-flex">
                ...
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => dispatch(openModal({ type: 'remove', channel }))}>{t('channels.btnRemove')}</Dropdown.Item>
                  <Dropdown.Item onClick={() => dispatch(openModal({ type: 'edit', channel }))}>{t('channels.btnRename')}</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </li>
          );
